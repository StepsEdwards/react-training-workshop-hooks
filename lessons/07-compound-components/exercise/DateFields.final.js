...
export default function DateFields({
  children,
  defaultValue,
  start, // DateField doesn't need this prop because it's only needed in the YearField
  end, // DateField doesn't need this prop because it's only needed in the YearField
